...
<body class="bg-gradient-primary" >
    <div class="tapiz">
        <img src="../img/desarrollo.jpg" alt="Fondo" class="img-difuminado">
    </div>
                        ...
                        <div class="p-5">
                            ...
                            <form  method="POST" action="{{ route('register') }}" class="user">
                                ...
                                <div class="form-group">
                                    <input name="document" type="text" class="form-control form-control-user" id="exampleDocument"
                                ...
                                <button type="submit" class="btn show btn-user btn-block">Registrar</button>
